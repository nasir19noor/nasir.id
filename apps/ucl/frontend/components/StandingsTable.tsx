...
// League-phase qualification zones: 1-8 straight to the R16, 9-24 into the
// play-offs, 25-36 eliminated.
const ZONE_BG: Record<Standing['zone'], string> = {
  direct:  'bg-accent/10',
  playoff: 'bg-blue-500/5',
  out:     '',
}
