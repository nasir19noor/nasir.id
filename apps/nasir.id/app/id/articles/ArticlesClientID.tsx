...
export default function ArticlesClientID() {
                ...
                <div className="max-w-6xl mx-auto px-6 py-12">
                    <div className="text-center">
                        ...
                        <p className="text-slate-600 text-lg max-w-2xl mx-auto mb-8">
                            Pemikiran tentang arsitektur cloud, praktik terbaik DevOps, dan teknologi
                            emerging yang membentuk masa depan rekayasa perangkat lunak.
                        </p>
                        ...
                        {activeTag && (
                            <div className="mt-4 flex items-center justify-center gap-2">
                                <span className="text-sm text-slate-600">
                                    Menampilkan artikel dengan tag <strong>#{activeTag}</strong>
                                </span>
                                <button
                                    onClick={() => router.push('/id/articles')}
                                ...
                                {searchTerm ? (
                                    <>
                                        ...
                                        <p className="text-gray-500">
                                            Tidak ada artikel yang cocok dengan pencarian "{searchTerm}". Coba kata kunci lain.
                                        </p>
                                    </>
                                ) : (
                                    <>
                                        <h3 className="text-lg font-semibold text-gray-900 mb-2">Belum ada artikel</h3>
                                        <p className="text-gray-500">Segera hadir konten baru!</p>
                                    </>
                                )}
                            </div>
                        </div>
                    ...
                    <>
                        ...
                        <div className="mb-8">
                            <p className="text-slate-600">
                                {searchTerm ? (
                                    <>Menampilkan {filteredArticles.length} hasil untuk "{searchTerm}"</>
                                ) : (
